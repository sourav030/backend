...
const Navbar = () => {
  ...
  return (
    <div className="relative flex justify-center">
      <div className="bg-black text-white fixed top-0 p-3 w-full font-bold flex justify-around border z-50">
        ...
        <NavLink to="/yourPost" className="text-lg hover:bg-gray-300">Yours Post</NavLink>
        {token ? (
          <p onClick={logout} className="text-lg hover:cursor-pointer hover:bg-gray-300">
            LogOut
          </p>
        ) : (
